...
(1 << (RACE_DRAENEI - 1)) | (1 << (RACE_HIGHELF - 1)) | (1 << (RACE_DRAGONMAW - 1)) | \
(1 << (RACE_REVANTUSK - 1)) | (1 << (RACE_WILDHAMMER - 1)) | \
 (1 << (RACE_WORGEN - 1)) | (1 << (RACE_DARKIRON - 1)))

#define RACEMASK_ALLIANCE \
     ((1<<(RACE_HUMAN-1)) | (1<<(RACE_DWARF-1)) | (1<<(RACE_NIGHTELF-1)) | \
 (1 << (RACE_DRAENEI - 1)) | (1 << (RACE_GNOME - 1)) | (1 << (RACE_DRAENEI - 1)) | (1 << (RACE_HIGHELF - 1)) | \
(1 << (RACE_WILDHAMMER - 1)) | (1 << (RACE_WORGEN - 1)))
...
enum Classes
{
    ...
    CLASS_NECROMANCER  = 6, // TITLE Death Knight
...
#define CLASSMASK_ALL_PLAYABLE \
  ((1<<(CLASS_WARRIOR-1))|(1<<(CLASS_PALADIN-1))|(1<<(CLASS_HUNTER-1))| \
    ...
    (1<<(CLASS_MAGE-1))   |(1<<(CLASS_WARLOCK-1))|(1<<(CLASS_DRUID-1)) | \
     (1<<(CLASS_WITCH-1)) | (1<<(CLASS_MONK-1)) | \
(1 << (CLASS_NECROMANCER - 1)) | (1 << (CLASS_BARD - 1)))
...
enum PlayerSpecializations
{
    ...
    SPEC_HUNTER_RANGER = 2,
    SPEC_HUNTER_BEAST_MASTERY = 3,
    ...
    SPEC_NECROMANCER_BLOOD = 0,
    SPEC_NECROMANCER_FROST = 1,
    SPEC_NECROMANCER_UNHOLY = 2,
    ...
    SPEC_WARLOCK_SOUL_REAPING = 1,
    SPEC_WARLOCK_DESTRUCTION = 2,
    SPEC_WARLOCK_DEMONOLOGY = 3,
    SPEC_DRUID_BALANCE = 0,
    SPEC_DRUID_FERAL = 1,
    SPEC_DRUID_RESTORATION = 2,
    SPEC_WITCH_SOUL_BINDING = 0,
    SPEC_WITCH_PREDATION = 1,
    SPEC_WITCH_VOODOO = 2,
    SPEC_MONK_FELLOWSHIP = 0,
    SPEC_MONK_DEVOTION = 1,
    SPEC_MONK_COMBAT =2,
    SPEC_WARDEN_NATURE = 0,
    SPEC_WARDEN_GUARDIAN = 1,
    SPEC_WARDEN_WATCHER = 3,
    SPEC_BARD_UNITY = 0,
    SPEC_BARD_SUBTERTFUGE = 1,
    SPEC_BARD_JESTER = 2,
};
...
enum SpellSchoolMask : uint32
{
    ...
    // 124, not include normal
    SPELL_SCHOOL_MASK_SPELL   = (SPELL_SCHOOL_MASK_FIRE   |
                                  SPELL_SCHOOL_MASK_NATURE | SPELL_SCHOOL_MASK_FROST  |
                                  SPELL_SCHOOL_MASK_SHADOW | SPELL_SCHOOL_MASK_ARCANE | SPELL_SCHOOL_MASK_HOLY),
    // 126
    SPELL_SCHOOL_MASK_MAGIC   = (SPELL_SCHOOL_MASK_SPELL),
...
enum SpellAttr7 : uint32
{
    ...
    SPELL_ATTR7_UNK12                            = 0x00001000, // TITLE Unknown attribute 12@Attr7 cast cast while mounted
...
enum SpellEffects
{
    ...
    SPELL_EFFECT_MONK_BLOCK                         = 165,
    SPELL_EFFECT_TEMP_LEARN_SPELL                   = 166,
...
enum GameobjectTypes
{
    ...
    GAMEOBJECT_TYPE_BG_NODE                 = 36
};

#define MAX_GAMEOBJECT_TYPE                  37             // sending to client this or greater value can crash client.
...
enum CreatureType
{
    ...
    CREATURE_TYPE_FOREST_GUARDIAN = 14,
    CREATURE_TYPE_FETISH = 15
};
...
enum CreatureFamily
{
    ...
    //custom
    //druid forest guardian
    CREATURE_FAMILY_FAERIE_DRAGON       = 47,
    CREATURE_FAMILY_DRYAD               = 48,
    CREATURE_FAMILY_TREANT              = 49,
    CREATURE_FAMILY_WISP                = 52,
    //witch creatures
    CREATURE_FAMILY_FETISH              = 53,
    CREATURE_FAMILY_JUNGLE_STALKER      = 54,
    CREATURE_FAMILY_SHADOW_PANTHER      = 55,
    CREATURE_FAMILY_JUNGLE_RAPTOR       = 56,
    //necromancer creatures
    //CREATURE_FAMILY_GHOUL 40
    CREATURE_FAMILY_REAVER              = 57,
    CREATURE_FAMILY_SKELETON_MAGE       = 58,
    CREATURE_FAMILY_N_GHOUL             = 59
};
...
enum QuestSort
{
    ...
    QUEST_SORT_NECROMANCER        = 372,
    QUEST_SORT_JEWELCRAFTING       = 373,
    QUEST_SORT_NOBLEGARDEN         = 374,
    QUEST_SORT_PILGRIMS_BOUNTY     = 375,
    QUEST_SORT_LOVE_IS_IN_THE_AIR  = 376,
    QUEST_SORT_WITCH = 377,
    QUEST_SORT_BARD = 378,
    QUEST_SORT_MONK = 379,
    QUEST_SORT_WARDEN = 380,
...
constexpr uint8 ClassByQuestSort(int32 QuestSort)
{
    switch (QuestSort)
    {
        ...
        case QUEST_SORT_WITCH:          return CLASS_WITCH;
        case QUEST_SORT_BARD:          return CLASS_BARD;
        case QUEST_SORT_MONK:          return CLASS_MONK;
        case QUEST_SORT_WARDEN:          return CLASS_WARDEN;
    }
    return 0;
}
...
enum SkillType
{
    ...
    SKILL_INTERNAL = 769,
    SKILL_PAIN = 770,  ///necro
    SKILL_PUPPETMASTER = 772,
    SKILL_DESOLATION = 773,
    ...
    SKILL_ARCHEOLOGY = 790,
    SKILL_BUCKLER = 791,
    SKILL_DOCTOR = 792,
    SKILL_SHADOW_HUNTER = 793,
    SKILL_SOUL_EATER = 794,
    SKILL_DEMONOLOGY = 795,
    SKILL_LANG_GOBLIN = 796,
    SKILL_PET_FETISH = 797,
    SKILL_BEAST_MASTERY = 798,
    SKILL_RACIAL_DRAGONMAW = 800,
    SKILL_RACIAL_HIGH_ELF = 801,
    SKILL_RACIAL_REVANTUSK = 802,
    SKILL_RACIAL_WILDHAMMER = 803,
    SKILL_RACIAL_BLACKFUSE = 804,
    SKILL_RACIAL_BILGEWATER = 805,
    SKILL_LANG_WORGEN = 806,
    SKILL_RACIAL_OGRE = 807,
    SKILL_RACIAL_DARKIRON = 808,
    SKILL_RACIAL_WORGEN = 809,
    SKILL_RACIAL_MECHAGNOME = 810,
    SKILL_PET_JCAT = 811,
    SKILL_PET_JPAT = 812,
    SKILL_PET_JRAP = 813,
    SKILL_PET_NGHOUL = 814,
    SKILL_PET_REAVER = 815,
    SKILL_PET_SKELETON = 816,
    SKILL_SUBTERFUGE = 817,  //bard
    SKILL_JESTER = 818,
    SKILL_UNITY = 819,
    SKILL_GUARDIAN = 820,  //warden
    SKILL_WATCHER = 821,
    SKILL_NATUREW = 822,
    SKILL_COMBATM = 823,   //monk
    SKILL_FELLOWSHIP = 824,
    SKILL_DEVOTION = 825,
    SKILL_MONKEY = 826,
    SKILL_COSMETIC = 827
};

#define MAX_SKILL_TYPE               828
...
enum SummonSlot
{
    ...
    SUMMON_SLOT_QUEST               = 6,
    SUMMON_SLOT_DEATH_FETISH = 7,
    SUMMON_SLOT_LIFE_FETISH = 8,
    MAX_SUMMON_SLOT
};
...
enum BattlegroundTypeId : uint32
{
    ...
    BATTLEGROUND_TP = 20, //twine peaks
    BATTLEGROUND_BFG = 21, //gilnea
    BATTLEGROUND_DG = 23,  // deepwind gorge
    BATTLEGROUND_TV = 25,  //tv arena
    BATTLEGROUND_TTP = 26,  //mop arena
    BATTLEGROUND_AF = 27,  //ashamen arena
    BATTLEGROUND_RB2 = 29,  //random battleground workaround
...
enum SpellFamilyNames
{
    ...
    // 14 - unused
    SPELLFAMILY_NECROMANCER = 15, // TITLE Death Knight
    // 16 - unused
    SPELLFAMILY_PET         = 17,
    SPELLFAMILY_WITCH = 18,
    SPELLFAMILY_FIRST_AID = 19,
    SPELLFAMILY_MONK = 20,
    SPELLFAMILY_BARD = 21,
    SPELLFAMILY_WARDEN = 22
};
...
enum BattlegroundQueueTypeId
{
    ...
    BATTLEGROUND_QUEUE_TP = 11,
    BATTLEGROUND_QUEUE_BFG = 12,
    BATTLEGROUND_QUEUE_DG = 14,
    BATTLEGROUND_QUEUE_RB2 = 15,
