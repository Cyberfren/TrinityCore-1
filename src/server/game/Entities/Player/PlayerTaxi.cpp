...
void PlayerTaxi::InitTaxiNodesForLevel(uint32 race, uint32 chrClass, uint8 level)
{
  ...
  //  }
    ...
    case RACE_NIGHTELF: SetTaximaskNode(26);
        SetTaximaskNode(27); break;

    case RACE_DARKIRON:      SetTaximaskNode(443); break;
    case RACE_DRAGONMAW:      SetTaximaskNode(443); break;
    case RACE_HIGHELF:      SetTaximaskNode(6); break;
    case RACE_WILDHAMMER: SetTaximaskNode(6); break;
    case RACE_REVANTUSK:   SetTaximaskNode(443); break;
    case RACE_DWARF:    SetTaximaskNode(6);  break;
    case RACE_WORGEN: SetTaximaskNode(26); break;
