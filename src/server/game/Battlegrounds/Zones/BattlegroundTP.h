...
enum BG_TP_BroadcastTexts
{
    ...
    BG_TP_TEXT_FLAG_PLACED_HORDE = 9803,
    BG_TP_TEXT_FLAG_PLACED_ALLIANCE = 9803,
...
enum BG_TP_ObjectTypes
{
    ...
    BG_TP_OBJECT_DOOR_H_5 = 8,
    BG_TP_OBJECT_A_FLAG = 9,
    BG_TP_OBJECT_H_FLAG = 10,
    BG_TP_OBJECT_SPEEDBUFF_1 = 11,
    BG_TP_OBJECT_SPEEDBUFF_2 = 12,
    BG_TP_OBJECT_REGENBUFF_1 = 13,
    BG_TP_OBJECT_REGENBUFF_2 = 14,
    BG_TP_OBJECT_BERSERKBUFF_1 = 15,
    BG_TP_OBJECT_BERSERKBUFF_2 = 16,
    BG_TP_OBJECT_IRON_NODE_1 = 17,
    BG_TP_OBJECT_IRON_NODE_2 = 18,
    BG_TP_OBJECT_FADE_NODE_1 = 19,
    BG_TP_OBJECT_THORN_NODE_1 = 20,
    BG_TP_OBJECT_GOLD_NODE_1 = 21,
    BG_TP_OBJECT_MAX = 22
};
...
enum BG_TP_ObjectEntry
{
  /*  BG_OBJECT_DOOR_A_1_TP_ENTRY = 179918,
    ...
    BG_OBJECT_DOOR_H_1_TP_ENTRY = 179919,
    BG_OBJECT_DOOR_H_2_TP_ENTRY = 179919,
    BG_OBJECT_DOOR_H_3_TP_ENTRY = 179920,
    ...
    BG_OBJECT_DOOR_H_5_TP_ENTRY = 208206,
  //  BG_OBJECT_DOOR_TOWER_ENTRY_A = 300100,
   // BG_OBJECT_DOOR_TOWER_ENTRY_H = 300102,
...
protected:
    BattlegroundTPScore(ObjectGuid playerGuid) : BattlegroundScore(playerGuid), FlagCaptures(0), FlagReturns(0) { }
...
private:
    ...
    void SpawnNodeTP(uint32 randomSet);
    void UpdateNodeStatus();
    void NodeOnUpdate(uint32 diff); // Called periodically


    //resources
    void HandleNodeRespawn(NodeInfo& node);
    std::vector<NodeInfo> nodes; // List of nodes in the battleground
