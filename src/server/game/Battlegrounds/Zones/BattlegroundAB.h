...
enum BG_AB_ObjectType
{
    ...
    BG_AB_OBJECT_IRON_NODE_1    = 57,
    BG_AB_OBJECT_IRON_NODE_2    = 58,
    BG_AB_OBJECT_FADE_NODE_1    = 59,
    BG_AB_OBJECT_THORN_NODE_1   = 60,
    BG_AB_OBJECT_GOLD_NODE_1    = 61,
    BG_AB_OBJECT_MAX = 62
};
...
public:
    ...
    void SpawnNodeAB(uint32 randomSet);
...
private:
    ...
    void HandleNodeRespawn(ZodeInfo& node);
    std::vector<ZodeInfo> nodes; // List of nodes in the battleground
